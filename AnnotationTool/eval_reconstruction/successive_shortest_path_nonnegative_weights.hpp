...
// Modified: Dmitrii Marin, dmitry.marin@gmail.com, Dec 2016 to avoid bug https://svn.boost.org/trac/boost/ticket/12701
//
...
public:
    ...
    reference operator[](key_type v) const {
		return std::max(value_type(0), get(distance_, source(v, g_)) - get(distance_, target(v, g_)) + get(weight_, v));
    }
private:
    const Graph & g_;
    Weight weight_;
