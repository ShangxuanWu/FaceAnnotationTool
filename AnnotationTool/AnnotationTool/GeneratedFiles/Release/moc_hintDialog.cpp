...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_hintDialog_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_hintDialog_t qt_meta_stringdata_hintDialog = {
    {
QT_MOC_LITERAL(0, 0, 10) // "hintDialog"
...
const QMetaObject hintDialog::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_hintDialog.data,
      qt_meta_data_hintDialog,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *hintDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_hintDialog.stringdata0))
